...
export const plain: Record<GlossaryKey, string> = {
  ...
  "autonomy.description":
    "Quanto o projeto anda sozinho: o que as execuções podem decidir sem você.",
  "autonomy.level.manual": "Nível 0 · Manual",
  "autonomy.level.suggest": "Nível 1 · Sugestões",
  "autonomy.level.propose": "Nível 2 · Propostas",
  "autonomy.level.policies": "Nível 3 · Políticas",
  "autonomy.level.delegate": "Nível 4 · Delegação",
  ...
  "autonomy.level.delegate.description":
    "Um agente pode delegar a outro: execuções filhas abrem sozinhas.",
  "autonomy.current": "Nível atual",
  "autonomy.change.title": "Subir a autonomia para {level}?",
  "autonomy.change.body": "A partir daí o projeto decide isto sem a sua aprovação:",
  "autonomy.change.action": "Subir o nível",
  "autonomy.change.done": "A autonomia agora é {level}.",
  "autonomy.allows.title": "O que este nível libera",
  "autonomy.allowed": "Liberado",
  "autonomy.blocked": "Não liberado",
  "autonomy.automation.suggest": "Sugerir Loadout, workflow e modelo",
  "autonomy.automation.autoApproveProposal": "Políticas aprovam propostas e criam tarefas",
  "autonomy.automation.autoApproveGate": "Políticas concedem aprovações",
  "autonomy.automation.autoDispatch": "Execuções iniciam sozinhas",
  "autonomy.automation.delegate": "Agentes delegam a outros agentes",
  "autonomy.scope.project": "Deste projeto",
  ...
  "autonomy.decidedBy.routing": "Regra de roteamento {name}",
  "autonomy.decidedBy.budget": "Orçamento {name}",
  "autonomy.decidedBy.breaker": "Disjuntor {name}",
  "autonomy.decidedBy.reset": "Reset manual",
  "autonomy.decidedBy.unknown": "Padrão do sistema",
  "autonomy.toast.budgetExceeded": "O orçamento {name} bloqueou uma execução",
  "autonomy.toast.breakerOpened": "O disjuntor {name} abriu",
  "autonomy.toast.breakerHalfOpen": "O disjuntor {name} deixou passar uma sondagem",
  "autonomy.toast.breakerClosed": "O disjuntor {name} fechou",
  "autonomy.toast.taskAutoCreated": "Uma política criou a tarefa {title}",
  "autonomy.toast.levelChanged": "A autonomia do projeto mudou para {level}",
  "autonomy.toast.open": "Abrir a autonomia",

  // ------------------------------------------------------------------ policy
  "entity.policy": "Política de aprovação",
  "entity.policy.plural": "Políticas de aprovação",
  "policy.description":
    "Cada política decide, sem você, o que fazer com um pedido: aprovar, exigir revisão ou recusar.",
  "policy.subject": "Assunto",
  "policy.subject.proposal": "Propostas de tarefa",
  "policy.subject.runStart": "Início da execução",
  "policy.subject.gate": "Aprovação no workflow",
  "policy.action": "Decisão da política",
  "policy.action.requireApproval": "Exige revisão",
  "policy.action.autoApprove": "Aprova sozinha",
  "policy.action.deny": "Recusa",
  "policy.inert": "Inerte neste nível",
  "policy.inert.hint":
    "Uma política que aprova sozinha só vale no nível 3 ou acima. Neste nível ela exige revisão.",
  "policy.priority.hint": "Maior vence. Empate entre as que casam é revisão humana.",
  "policy.conditions": "Condições",
  "policy.conditions.hint":
    "Todas as condições marcadas precisam valer. Sem nenhuma, a política casa com tudo.",
  "policy.list.empty": "Nenhuma política ainda. Sem política, toda decisão é sua.",
  "policy.create.title": "Nova política",
  "policy.edit.title": "Editar a política",
  "policy.save.done": "A política foi gravada.",
  "policy.delete.title": "Apagar esta política?",
  "policy.delete.body":
    "As decisões já tomadas por ela ficam registradas; as próximas voltam para você.",
  "policy.delete.done": "A política foi apagada.",

  // --------------------------------------------------------------- condition
  "condition.executionMode": "Modo de execução",
  "condition.harnessKey": "Harness",
  "condition.taskKind": "Tipo da tarefa",
  "condition.taskPriority": "Prioridade da tarefa",
  "condition.hasCommandTools": "Leva ferramentas de comando",
  "condition.enforcement": "Nível de enforcement",
  "condition.stepType": "Tipo da etapa do workflow",
  "condition.maxEstimatedTokens": "Estimativa de tokens até",
  "condition.loadoutId": "Loadout",
  "condition.projectId": "Projeto",
  "condition.minBudgetPressure": "Pressão do orçamento a partir de",
  "condition.any": "qualquer um destes",

  // ------------------------------------------------------------------ budget
  "entity.budget": "Orçamento",
  "entity.budget.plural": "Orçamentos",
  "budget.description":
    "Um teto de consumo por janela: tokens, execuções, tempo e execuções simultâneas. No teto, o orçamento barra ou avisa.",
  "budget.scope.global": "Global",
  "budget.scope.project": "Projeto",
  "budget.scope.loadout": "Loadout",
  "budget.window.day": "Por dia",
  "budget.window.week": "Por semana",
  "budget.window.month": "Por mês",
  "budget.window.perRun": "Por execução",
  "budget.action.block": "Barra",
  "budget.action.warn": "Avisa",
  "budget.limit.maxTokens": "Teto de tokens",
  "budget.limit.maxRuns": "Execuções",
  "budget.limit.maxWallClockMs": "Tempo de execução",
  "budget.limit.maxConcurrentRuns": "Execuções ao mesmo tempo",
  "budget.usage.unknown": "Consumo incerto",
  "budget.usage.unknown.hint":
    "{n} execuções terminaram sem reportar tokens; o orçamento não libera sobre uma soma que não conhece.",
  "budget.usage.pressure": "Pressão",
  "budget.usage.exceeded": "No teto",
  "budget.usage.window": "Janela",
  "budget.usage.perRun": "Medido na última execução encerrada",
  "budget.limits.hint": "Pelo menos um teto. Por execução só aceita tokens e tempo.",
  "budget.locked": "Escopo e janela não mudam: apague este e crie outro.",
  "budget.list.empty": "Nenhum orçamento ainda. Sem teto, toda execução parte.",
  "budget.create.title": "Novo orçamento",
  "budget.edit.title": "Editar o orçamento",
  "budget.save.done": "O orçamento foi gravado.",
  "budget.delete.title": "Apagar este orçamento?",
  "budget.delete.body":
    "As execuções que ele barrou ficam registradas; as próximas partem sem este teto.",
  "budget.delete.done": "O orçamento foi apagado.",
  "budget.exceeded.title": "Orçamento no teto",
  "budget.run.title": "Orçamento desta execução",
  "budget.run.hint":
    "O teto por execução é conferido pelo Worker durante a execução (Fase 9B); aqui, o consumo medido contra ele.",

  // ----------------------------------------------------------------- breaker
  "entity.breaker": "Disjuntor",
  "entity.breaker.plural": "Disjuntores",
  "breaker.description":
    "Depois de falhas seguidas, o disjuntor abre: nenhuma execução parte até o tempo de espera passar e uma sondagem terminar bem.",
  "breaker.scope.project": "Projeto",
  "breaker.scope.loadout": "Loadout",
  "breaker.scope.harness": "Harness",
  "breaker.state.closed": "Fechado · deixa passar",
  "breaker.state.open": "Aberto · recusa",
  "breaker.state.halfOpen": "Meio aberto · uma sondagem por vez",
  "breaker.openedAt": "Aberto {when}",
  "breaker.reopensAt": "Sonda de novo {when}",
  "breaker.probe": "Sondagem em curso",
  "breaker.probe.run": "Execução de sondagem",
  "breaker.consecutiveFailures": "Falhas seguidas",
  "breaker.trigger.consecutiveFailures": "Abre com {n} falhas seguidas",
  "breaker.trigger.failuresInWindow": "Abre com {n} falhas em {window}",
  "breaker.trigger.permissionDeniedInWindow": "Abre com {n} permissões negadas em {window}",
  "breaker.trigger.authNotAuthenticated": "Abre quando o harness perde a credencial",
  "breaker.cooldown": "Tempo de espera",
  "breaker.triggers.hint": "Pelo menos um gatilho. Qualquer um que dispare abre.",
  "breaker.locked":
    "Escopo e estado não mudam por aqui: o estado só muda pelos desfechos e pelo reset.",
  "breaker.reset": "Fechar o disjuntor",
  "breaker.reset.title": "Fechar o disjuntor {name}?",
  "breaker.reset.body":
    "O disjuntor volta a fechado, zera o contador e as execuções partem de novo, mesmo que a causa das falhas não tenha sido resolvida.",
  "breaker.reset.done": "O disjuntor está fechado de novo.",
  "breaker.list.empty": "Nenhum disjuntor ainda. Falhas seguidas não param nada.",
  "breaker.create.title": "Novo disjuntor",
  "breaker.edit.title": "Editar o disjuntor",
  "breaker.save.done": "O disjuntor foi gravado.",
  "breaker.delete.title": "Apagar este disjuntor?",
  "breaker.delete.body":
    "As execuções que ele barrou ficam registradas; as próximas partem sem esta proteção.",
  "breaker.delete.done": "O disjuntor foi apagado.",
  "breaker.open.title": "Disjuntor aberto",
  "breaker.probe.title": "Esta execução é a sondagem de {name}",
  "breaker.probe.body": "Se ela terminar bem, o disjuntor fecha; se falhar, ele abre de novo.",

  // ----------------------------------------------------------------- routing
  "entity.routingRule": "Regra de roteamento",
  "entity.routingRule.plural": "Regras de roteamento",
  "routing.description":
    "Por condições, escolhe o modelo, o Loadout ou o workflow: o alvo preferido, e os reservas em ordem. Sem regra que case, vale o padrão.",
  "routing.kind.model": "Modelo",
  "routing.kind.loadout": "Loadout",
  "routing.kind.workflow": "Workflow",
  ...
  "routing.fallbacks.hint":
    "Tentados quando o preferido não serve: um modelo de outro harness, um alvo apagado.",
  "routing.model.note":
    "Uma regra de modelo só vale quando o Loadout deixa o modelo em branco: um modelo escolhido no Loadout é decisão sua.",
  "routing.kindLocked": "A espécie não muda: apague e crie de novo.",
  "routing.list.empty":
    "Nenhuma regra ainda. Vale o padrão: o Loadout marcado, o workflow da tarefa, o modelo do harness.",
  "routing.create.title": "Nova regra de roteamento",
  "routing.edit.title": "Editar a regra",
  "routing.save.done": "A regra foi gravada.",
  "routing.delete.title": "Apagar esta regra?",
  "routing.delete.body":
    "As escolhas já feitas ficam registradas nas execuções; as próximas voltam ao padrão.",
  "routing.delete.done": "A regra foi apagada.",

  // -------------------------------------------------------------- suggestion
  "suggestion.title": "Sugestões",
  "suggestion.description":
    "As regras de roteamento do projeto, avaliadas com os fatos da tarefa. Troque o que quiser antes de partir.",
  "suggestion.loading": "Consultando as sugestões…",
  "suggestion.disabled": "O nível de autonomia deste projeto não sugere nada (nível 0).",
  "suggestion.none": "Sem sugestão: vale o padrão.",
  "suggestion.applied": "Pré-selecionado",
  "suggestion.model.note": "Aplicado na partida quando o Loadout deixa o modelo em branco.",
  "suggestion.workflow.apply": "Usar este workflow na tarefa",
  "suggestion.workflow.applied": "A tarefa passou a usar o workflow sugerido.",
  "suggestion.pressure": "Pressão do orçamento",

  // ------------------------------------------------------------ run.decision
  "run.departed.policy": "Política na partida: {reason}",
  "run.departed.routing": "Modelo roteado: {name}",
  "run.departed.budgetWarning": "Orçamento {name} perto do teto: {current} de {limit}",
  "run.departed.probe": "A execução partiu como sondagem do disjuntor {name}.",
  "run.refused.policy": "Partida recusada por política",
  "run.refused.hint": "Ajuste na autonomia do projeto e tente de novo.",
  "run.refused.open": "Abrir a autonomia",

  // -------------------------------------------------------------- run.origin
  "run.origin": "Origem",
  "run.origin.user": "Você",
  "run.origin.policy": "Política",
  "run.origin.delegation": "Delegação",
  "run.parent": "Execução mãe",
  "run.parentStep": "Etapa que delegou",
  "run.children.title": "Execuções filhas",
  "run.children.empty": "Nenhuma execução filha.",
  "run.model.selectedBy": "Modelo escolhido por",
  "run.model.loadout": "pelo Loadout",
  "run.model.harnessDefault": "padrão do harness",

  // ------------------------------------------------------------- task.origin
  "task.origin.user": "Criada por você",
