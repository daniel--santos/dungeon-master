...
export const plain: Record<GlossaryKey, string> = {
  ...
  "settings.prices.description":
    "Quanto cobra cada modelo, por milhão de tokens, e como cada provedor fatura. Sem preço cadastrado, a observabilidade diz que não mediu — nunca que custou zero.",
  "settings.prices.model": "Modelo",
  ...
  "settings.prices.empty": "Nenhum modelo cadastrado ainda.",
  ...
  "settings.prices.history.empty": "Este modelo nunca teve preço cadastrado.",
  "settings.prices.providers": "Como cada provedor fatura",
  "settings.prices.providers.description":
    "Por token, a conta sai do preço do modelo. Por assinatura, a mensalidade é rateada pela fatia de tokens do mês.",
  "settings.prices.providers.empty": "Nenhum provedor cadastrado ainda.",
  ...
  "provider.billing.estimateNote":
    "O custo de uma assinatura é estimativa: a mensalidade é rateada pela fatia de tokens deste provedor no mês civil, e muda até o mês fechar.",

  // -------------------------------------------------------------- metrics
  "metrics.description":
    "O que as execuções consumiram na janela, e de onde cada número saiu. Um valor que não foi medido aparece como não medido, nunca como zero.",
  ...
  "metrics.empty.title": "Nenhuma execução terminou ainda",
  "metrics.empty.description":
    "A observabilidade só enxerga execução acabada e já projetada. Dispare uma e volte aqui quando ela terminar.",
  "metrics.tile.runs": "Execuções",
  "metrics.tile.successRate": "Taxa de sucesso",
  "metrics.tile.tokens": "Tokens",
  "metrics.tile.cost": "Custo",
  "metrics.tile.duration": "Duração",
  "metrics.tile.breakers": "Disjuntores abertos",
  "metrics.tile.workers": "Workers",
  "metrics.runs.succeeded": "Concluídas",
  "metrics.runs.failed": "Falharam",
  "metrics.runs.timedOut": "Tempo esgotado",
  "metrics.runs.cancelled": "Canceladas",
  "metrics.runs.none": "nenhuma execução na janela",
  "metrics.tokens.measured": "{known} de {total} execuções com tokens medidos",
  ...
  "metrics.tokens.unknown": "o harness não reportou tokens",
  ...
  "metrics.duration.measured": "{n} execuções medidas",
  "metrics.breakers.open": "de {total} ligados",
  ...
  "metrics.metric.runs": "Execuções",
  "metrics.metric.tokens": "Tokens",
  "metrics.metric.duration": "Duração",
  "metrics.metric.cost": "Custo",
  "metrics.dimension.all": "Tudo somado",
  "metrics.dimension.project": "Projeto",
  "metrics.dimension.harness": "Harness",
  "metrics.dimension.model": "Modelo",
  "metrics.dimension.provider": "Provedor",
  "metrics.dimension.loadout": "Loadout",
  "metrics.dimension.createdBy": "Quem disparou",
  "metrics.dimension.taskKind": "Tipo de tarefa",
  ...
  "metrics.worker.description":
    "Cada processo que bate o coração no banco, o que ele ainda segura e os harnesses que ele autenticou no boot.",
  ...
  "metrics.worker.runningRuns": "Execuções em curso",
  "metrics.worker.capacity": "Teto",
  "metrics.worker.harnesses": "Harnesses",
  "metrics.project.title": "Métricas do projeto",
  "metrics.project.open": "Abrir a observabilidade",
  "metrics.project.subscriptionNote":
    "O rateio de assinatura não desce ao nível de projeto: aqui as execuções de provedor por assinatura entram como não medidas.",

  // ------------------------------------------------------------ run.metrics
  "run.tab.overview": "A execução",
  "run.tab.metrics": "Métricas",
  "run.metrics.empty":
    "Esta execução ainda não foi medida. A quebra aparece quando ela termina e o projetor passa.",
  "run.metrics.tokens": "Tokens",
  "run.metrics.context": "Contexto contra prompt",
  ...
  "run.metrics.context.none": "Esta execução partiu sem contexto montado.",
  "run.metrics.tools": "Ferramentas por servidor MCP",
  "run.metrics.tools.native": "do próprio harness",
  "run.metrics.tools.empty": "Nenhuma ferramenta foi usada.",
  "run.metrics.steps": "Etapas do workflow",
  "run.metrics.steps.empty": "Esta execução não seguiu workflow.",
  "run.metrics.gates": "Aprovações concedidas",
  "run.metrics.gates.user": "por você",
  "run.metrics.gates.policy": "por política",
  "run.metrics.children": "Execuções filhas",
