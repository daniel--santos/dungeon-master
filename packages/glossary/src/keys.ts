...
export const GLOSSARY_KEYS = [
  ...
  "nav.registry",
  "nav.hall",
  // A tela de observabilidade avançada (Fase 10B): métricas, custo e Workers.
  "nav.observability",
  "nav.settings",
  ...
  // O bloco de preços em Settings (Fase 10B): a vigência por Model e como cada
  // Provider cobra.
  ...
  "settings.prices.cacheRead",
  "settings.prices.cacheWrite",
  "settings.prices.effectiveFrom",
  "settings.prices.perMillion",
  "settings.prices.none",
  "settings.prices.empty",
  "settings.prices.open",
  "settings.prices.openTitle",
  "settings.prices.note",
  "settings.prices.save",
  "settings.prices.saved",
  "settings.prices.history",
  "settings.prices.history.current",
  "settings.prices.history.empty",
  "settings.prices.providers",
  "settings.prices.providers.description",
  "settings.prices.providers.empty",
  "settings.prices.savedProvider",

  // --------------------------------------------------------- provider.billing
  // Como um Provider cobra (Fase 10B), na tela dele e no bloco de preços.
  "provider.billing.kind",
  "provider.billing.perToken",
  "provider.billing.subscription",
  "provider.billing.unknown",
  "provider.billing.monthlyCost",
  "provider.billing.currency",
  "provider.billing.estimateNote",

  // -------------------------------------------------------------- metrics
  // A tela de observabilidade avançada (Fase 10B): tiles, séries, quebra por
  // dimensão, custo com procedência e presença de Worker.
  "metrics.description",
  "metrics.window",
  "metrics.window.d7",
  "metrics.window.d30",
  ...
  "metrics.tile.runs",
  "metrics.tile.successRate",
  "metrics.tile.tokens",
  "metrics.tile.cost",
  "metrics.tile.duration",
  "metrics.tile.breakers",
  "metrics.tile.workers",
  "metrics.runs.succeeded",
  "metrics.runs.failed",
  "metrics.runs.timedOut",
  ...
  "metrics.cost.status.priced",
  "metrics.cost.status.estimated",
  "metrics.cost.status.notMeasured",
  "metrics.cost.nothingPriced",
  "metrics.cost.notMeasuredRuns",
  "metrics.cost.subscriptionNote",
  "metrics.duration.average",
  "metrics.duration.p95",
  "metrics.duration.max",
  "metrics.duration.measured",
  "metrics.breakers.open",
  "metrics.workers.online",
  "metrics.workers.stale",
  "metrics.workers.offline",
  "metrics.series.title",
  "metrics.series.metric",
  "metrics.series.dimension",
  "metrics.series.empty",
  "metrics.series.chartLabel",
  "metrics.series.day",
  ...
  "metrics.metric.cost",
  "metrics.dimension.all",
  "metrics.dimension.project",
  "metrics.dimension.harness",
  "metrics.dimension.model",
  "metrics.dimension.provider",
  "metrics.dimension.loadout",
  "metrics.dimension.createdBy",
  "metrics.dimension.taskKind",
  "metrics.dimension.executionMode",
  "metrics.breakdown.title",
  "metrics.breakdown.empty",
  "metrics.worker.title",
  "metrics.worker.description",
  "metrics.worker.empty",
  "metrics.worker.status.online",
  "metrics.worker.status.stale",
  "metrics.worker.status.offline",
  "metrics.worker.host",
  "metrics.worker.pid",
  "metrics.worker.version",
  "metrics.worker.lastHeartbeat",
  "metrics.worker.runningRuns",
  "metrics.worker.capacity",
  "metrics.worker.harnesses",
  "metrics.project.title",
  "metrics.project.open",
  "metrics.project.subscriptionNote",

  // ------------------------------------------------------------ run.metrics
  // A aba de medidas do cockpit (Fase 10B), e as duas abas que ela cria.
  "run.tab.overview",
  "run.tab.metrics",
  "run.metrics.empty",
  "run.metrics.tokens",
  "run.metrics.context",
  "run.metrics.context.estimated",
  "run.metrics.context.items",
  "run.metrics.context.sections",
  "run.metrics.context.truncations",
  "run.metrics.context.none",
  "run.metrics.tools",
  "run.metrics.tools.native",
  "run.metrics.tools.empty",
  "run.metrics.steps",
  "run.metrics.steps.empty",
  "run.metrics.gates",
  "run.metrics.gates.user",
  "run.metrics.gates.policy",
  "run.metrics.children",
  "run.metrics.timing",
  "run.metrics.timing.duration",
  "run.metrics.timing.queue",
  "run.metrics.cost",
] as const;
